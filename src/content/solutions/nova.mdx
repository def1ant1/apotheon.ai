...
diagram:
  ...
  caption: 'Nova automates sandbox provisioning, policy guardrails, and live monitoring so experimentation stays compliant.'
hero:
...
crossLinks:
  - title: 'BWC-CUM Control Mesh'
    description: 'Inherit certified control baselines from BWCCUM before promoting experiments into production lanes.'
    href: '/solutions/bwccum/'
    label: 'Align experiments with BWCCUM'
