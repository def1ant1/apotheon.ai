...
diagram:
  slug: 'governance-lakehouse'
  alt: 'Governance Lakehouse flows streaming policy inputs into an evidence lake with audit exports.'
  caption: 'The Governance Lakehouse standardizes policy inputs and audit evidence so compliance teams pull reports instantly.'
hero:
