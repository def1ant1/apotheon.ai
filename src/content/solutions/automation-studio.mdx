...
diagram:
  ...
  alt: 'Automation Studio lanes connecting model decisions, human reviews, and escalation circuits.'
  caption: 'Automation Studio choreographs model, human, and escalation tracks so regulated workflows stay auditable.'
hero:
