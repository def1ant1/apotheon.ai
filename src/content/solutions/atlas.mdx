...
diagram:
  slug: 'atlas'
  alt: 'Atlas activation suite connecting warehouse policies, governed audiences, and downstream channels.'
  caption: 'Atlas syncs governed policies and compliant audiences into activation channels without custom ETL maintenance.'
hero:
