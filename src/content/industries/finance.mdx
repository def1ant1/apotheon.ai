---
# Slug contract: keep this file named `finance` to align with the 2024 IA migration to /industries/finance.
...
solutionMap:
  ...
  - slug: bwccum
    positioning: Automates capital, liquidity, and privacy controls across core banking stacks with signed remediation evidence.
    outcome: 72-hour regulator responses shrink to real-time attestations backed by BWCCUM exports.
  - slug: themis
