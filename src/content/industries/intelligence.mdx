...
solutionMap:
  ...
  - slug: bwccum
    positioning: Automates ICD 503 and cross-domain control enforcement with attested remediation across compartmented enclaves.
    outcome: Shrinks oversight board approvals from months to BWCCUM-triggered continuous reviews.
  - slug: themis
