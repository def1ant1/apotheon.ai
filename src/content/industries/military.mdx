...
solutionMap:
  ...
  - slug: bwccum
    positioning: Enforces RMF controls across mission systems with continuous evidence capture for IL5/IL6 authorizations.
    outcome: Cuts continuous ATO package prep from quarters to automated BWCCUM drops.
  - slug: morpheus
