...
solutionMap:
  # Automation guard: ensure civic playbooks reference current solution slugs for IA parity.
  - slug: bwccum
    positioning: Automates cross-agency control enforcement with continuous evidence streaming for OMB and StateRAMP reviews.
    outcome: Drops audit packet compilation from weeks to same-day BWCCUM exports.
  - slug: clio
