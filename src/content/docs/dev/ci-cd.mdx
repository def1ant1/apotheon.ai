...
sourceLastModified: 2025-09-28T21:16:01.507Z
tags: []
---
...
implemented in [`.github/workflows/ci.yml`](https://github.com/apotheonai/apotheon.ai/blob/main/.github/workflows/ci.yml) and
...
strict budgets defined in [`lighthouserc.json`](https://github.com/apotheonai/apotheon.ai/blob/main/lighthouserc.json). Key
...
restricted via [`zap-baseline.conf`](https://github.com/apotheonai/apotheon.ai/blob/main/zap-baseline.conf) so only the static
...
our curated configuration ([`.gitleaks.toml`](https://github.com/apotheonai/apotheon.ai/blob/main/.gitleaks.toml)). The config
