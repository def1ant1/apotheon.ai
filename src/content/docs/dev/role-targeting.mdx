...
description: >-
  Apotheon.ai marketing surfaces (homepage hero, contact form, docs landing)
  now share a single resolver at `src/utils/audience-resolver.ts`. Append
  `?role=<id>` to any marketing URL and the system hydrates curated copy, CTAs,
  and analytics automatically.
sourcePath: dev/ROLE-TARGETING.md
sourceLastModified: 2025-09-28T04:46:50.971Z
tags: []
---
