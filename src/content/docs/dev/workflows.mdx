...
> **Onboarding reminder:** Before diving into workflow specifics, review the [README Quick Start](https://github.com/apotheon-ai/apotheon.ai/blob/main/README.md#quick-start) for the required tooling cadence and the [README Features](https://github.com/apotheon-ai/apotheon.ai/blob/main/README.md#features) recap so your local environment mirrors the static-first contract described in the hero block.
...
The [README Quick Start](https://github.com/apotheon-ai/apotheon.ai/blob/main/README.md#quick-start) is the canonical source
