...
description: The `/about/contact/` experience now routes through a Cloudflare
  Worker so every inquiry lands in auditable infrastructure backed by D1. This
...
sourceLastModified: 2025-09-29T00:17:47.286Z
tags: []
---
...
> **Onboarding reminder:** Before diving into workflow specifics, review the [README Quick Start](https://github.com/apotheonai/apotheon.ai/blob/main/README.md#quick-start) for the required tooling cadence and the [README Features](https://github.com/apotheonai/apotheon.ai/blob/main/README.md#features) recap so your local environment mirrors the static-first contract described in the hero block.
...
The [README Quick Start](https://github.com/apotheonai/apotheon.ai/blob/main/README.md#quick-start) is the canonical source
