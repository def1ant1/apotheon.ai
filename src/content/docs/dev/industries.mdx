...
> **2024 IA requirement:** The finance route is canonicalized at `/industries/finance`. Keep the file name, navigation slug, CTA query parameters, and any supporting assets aligned with `finance`—the legacy `financial-services` path remains deprecated.
