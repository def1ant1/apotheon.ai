...
description: Enterprise buyers expect deterministic navigation affordances that
  scale across locales, screen readers, and motion preferences. This document
