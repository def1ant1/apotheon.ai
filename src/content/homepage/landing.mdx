...
modules:
  - name: 'BWCCUM Orchestration Mesh'
    summary: 'Deterministic DAG orchestration runs policy-aware workflows across every region while teeing up remediation packets for Themis. Request the BWCCUM runbook via the investor portal to download the FEDGEN oversight briefing.'
    href: '/about/white-papers/?whitepaperSlug=apotheon-investor-brief#whitepaper-request'
    icon: 'nova'
