...
- **Platform** → `/solutions/clio`, `/solutions/mnemosyne`, `/solutions/nova`
- **Industries** → `/industries/healthcare`, `/industries/financial-services`, `/industries/law`, `/industries/government`, `/industries/military`, `/industries/intelligence`, `/industries/public-sector`
