 ...
 */
export const BASELINE_DIRECTIVES = {
  'default-src': ["'self'"],
  'base-uri': ["'self'"],
  'object-src': ["'none'"],
 ...
 */
const cloneDirectives = (directives) =>
  Object.fromEntries(
 ...
 */
export const createNonce = (size = 16) => crypto.randomBytes(size).toString('base64url');
/**
 ...
 */
export const serializeDirectives = (directives) =>
 ...
 */
export const toAstroContentSecurityPolicy = (directives) =>
  Object.fromEntries(
 ...
 */
export const buildCspHeaders = ({ nonce, reportOnly = false, reportUri, overrides } = {}) => {
 ...
 */
export const buildReportToHeader = (reportUri, group = REPORTING_GROUP) =>
  JSON.stringify({
    group,
